...
namespace shop.Data.ApplicationContext
{
    public class SqlServerApplicationContext : DbContext,IApplicationContext
    {
        ...
        //overide onconfiguring
        // protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        // {
        //     optionsBuilder.UseSqlServer("Data Source=arthur.iran.liara.ir,34334;Initial Catalog=myDB;User Id=sa;Password=ayzcpOW3Hm0vEYffKuJO1BWf;MultipleActiveResultSets=true;TrustServerCertificate=true");
        // }
